...
func TestNormalize(t *testing.T) {
	tests := []struct {
		...
		{
			[10]uint32{
				0xffffffff, 0xffffffc0, 0xffffffc0, 0x3ffc0, 0, 0, 0, 0,
				0, 0,
			},
			[10]uint32{
				0x03ffffff, 0x03ffffff, 0x03ffffff, 0x3ffff, 0, 0, 0, 0,
				0, 0,
			},
		},
		// 2^96
		{
			[10]uint32{
				0x04000000, 0x03ffffff, 0x03ffffff, 0x3ffff, 0, 0, 0, 0,
				0, 0,
			},
			[10]uint32{
				0x00000000, 0x00000000, 0x00000000, 0x40000, 0, 0, 0, 0,
				0, 0,
			},
		},
		// 2^128 - 1
		{
			[10]uint32{
				0xffffffff, 0xffffffc0, 0xffffffc0, 0xffffffc0, 0xffffc0,
				0, 0, 0, 0, 0,
			},
			[10]uint32{
